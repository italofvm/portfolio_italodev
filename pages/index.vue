  ...
  <div class="relative">
    ...
    >
      <div class="container mx-auto px-4 flex justify-between items-center">
        <a href="#" class="text-2xl font-bold tracking-tighter text-white" aria-label="Italo Vieira - Página inicial">
      ...
      <Transition name="mobile-menu">
        <div v-if="mobileMenuOpen" class="md:hidden absolute top-full left-0 w-full bg-primary-dark border-b border-white/10 p-4 flex flex-col space-y-4 shadow-xl">
          <a href="#servicos" @click="mobileMenuOpen = false" class="text-gray-300 hover:text-white transition-colors">Serviços</a>
          <a href="#portfolio" @click="mobileMenuOpen = false" class="text-gray-300 hover:text-white transition-colors">Portfólio</a>
          <a href="#depoimentos" @click="mobileMenuOpen = false" class="text-gray-300 hover:text-white transition-colors">Clientes</a>
          <a href="#faq" @click="mobileMenuOpen = false" class="text-gray-300 hover:text-white transition-colors">FAQ</a>
    ...
    <!-- Services Section -->
    <section id="servicos" class="py-20 bg-primary-dark relative" aria-labelledby="services-heading">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 id="services-heading" class="section-title text-3xl md:text-5xl font-bold text-white mb-4">Como posso ajudar?</h2>
    ...
    <!-- Portfolio Section -->
    <section id="portfolio" class="py-20 bg-black/20" aria-labelledby="portfolio-heading">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <span class="section-badge text-cta font-bold tracking-widest text-sm uppercase" aria-hidden="true">Portfólio</span>
          <h2 id="portfolio-heading" class="section-title text-3xl md:text-5xl font-bold text-white mt-2 mb-4">Projetos Recentes</h2>
    ...
    <section id="depoimentos" class="py-20 bg-primary-dark" aria-labelledby="testimonials-heading">
      <div class="container mx-auto px-4">
        <h2 id="testimonials-heading" class="section-title text-3xl md:text-4xl font-bold text-white text-center mb-12">O que dizem os clientes</h2>
    ...
    <section id="faq" class="py-20 bg-black/20" aria-labelledby="faq-heading">
      <div class="container mx-auto px-4 max-w-3xl">
        <h2 id="faq-heading" class="section-title text-3xl md:text-4xl font-bold text-white text-center mb-12">Perguntas Frequentes</h2>
    ...
    <!-- Contact Section -->
    <section id="contato" class="py-20 bg-primary-dark relative overflow-hidden" aria-labelledby="contact-heading">
      <!-- Decorator -->
      ...
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 id="contact-heading" class="contact-title text-4xl md:text-6xl font-bold text-white mb-6">Vamos tirar sua ideia do papel?</h2>
...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://seudominio.com' }
  ],
  script: [
    {
